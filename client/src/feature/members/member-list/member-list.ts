...
import { FilterModal } from '../filter-model/filter-model';
...
export default class MemberList implements OnInit {
  ...
  get displayMessage(): string {
    ...
    if(this.updatedParams.minAge !== defaultParams.minAge || this.updatedParams.maxAge !== defaultParams.maxAge) {
      filters.push(`ages ${this.updatedParams.minAge}-${this.updatedParams.maxAge} years old`);
    }
